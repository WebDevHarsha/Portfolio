...
const Navbar = () => {
  ...
  return (
    <div className="sticky top-0 z-50 w-full">
      <nav className="bg-white border-gray-200 dark:bg-black w-full">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="./self.jpg" className="h-14 rounded-full" alt="Sri Harsha Logo" />
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Sri Harsha</span>
          </a>
          <button
            type="button"
